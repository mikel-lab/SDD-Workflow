...
After each native batch or correction, return the complete Implementer Result and submit the delivery to independent `implementation_review`. An implementer does not approve its own work, advance lifecycle state, or declare the workflow complete.
